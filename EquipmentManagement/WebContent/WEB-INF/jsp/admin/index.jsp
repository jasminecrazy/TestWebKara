...
<body data-ng-app="myApp" class="nav-md"
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_title">
									<div class="clearfix"></div>
									<h3>List Category Information</h3>
								</div>
								...
								<div class="modal-content">
										...
										<form class="form-horizontal" name="frmFormAdd"
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class=" control-label" for="">Category ID</label>
													<div class="">
														<input id="CategoryId" name="CategoryId"
															ng-keyup="hideDuplicateAlert()"
															class="form-control input-md"
															ng-keydown="autoAdd($event)" type="text"
															ng-model="add_CategoryId" ng-required="true" />
														<div ng-messages="frmFormAdd.CategoryId.$error">
															<div ng-message="required"
																ng-show="frmFormAdd.CategoryId.$touched">
												...
												<div class="form-group">
													...
													<div class="">
														<input id="CategoryName" name="CategoryName"
															...
															ng-model="add_CategoryName" ng-required="true" />
									...
									<div class="modal-footer">
										...
										<button id="btnSave" name="btnSave" class="btn btn-default"
											ng-click="add(true)"
											ng-disabled="frmFormAdd.CategoryId.$error.required || frmFormAdd.CategoryName.$error.required||frmFormAdd.lyric.$error.required||frmFormAdd.lyric.$error.required||frmFormAdd.youtube.$error.required ">Add
											and close</button>
						...
						<!-- Modal edit Category information -->
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="">
														<input id="CategoryId" name="CategoryId"
															ng-keyup="hideDuplicateAlert()"
															class="form-control input-md" type="text"
															ng-model="edit_CategoryId" ng-required="true" />
														<div ng-messages="editForm.CategoryId.$error">
															<div ng-message="required"
																ng-show="editForm.CategoryId.$touched">
																<p style="color: red">This field is required</p>
															</div>
														</div>
													</div>
												...
												<div class="form-group">
													...
													<div class="">
														<input id="CategoryName" name="CategoryName"
															class="form-control input-md" type="text"
															ng-model="edit_CategoryName" ng-required="true" />
									...
									<div class="modal-footer">
										...
										<button id="btnSave" name="btnSave" class="btn btn-primary"
											ng-disabled="editForm.CategoryId.$error.required || editForm.CategoryName.$error.required||editForm.lyric.$error.required||editForm.lyric.$error.required||editForm.youtube.$error.required "
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/assets/scripts/categoryCtrl.js"></script>
