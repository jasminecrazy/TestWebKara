...
<body>
	...
	<div class="w3-top">
		<div class="w3-bar w3-white w3-card-2" id="myNavbar">
			...
			<div class="w3-right w3-hide-small">
				<a href="#about" class="w3-bar-item w3-button">Vol 62</a> <a
					href="#team" class="w3-bar-item w3-button">Vol 61</a> <a
					href="#work" class="w3-bar-item w3-button">Vol 60</a> <a
					href="#pricing" class="w3-bar-item w3-button">Nhạc Việt</a> <a
					href="#contact" class="w3-bar-item w3-button">Nhạc Tiếng Anh</a>
			</div>
	...
	<nav
		...
		href="#about" onclick="w3_close()" class="w3-bar-item w3-button">Vol
		62</a> <a href="#team" onclick="w3_close()" class="w3-bar-item w3-button">Vol
		61</a> <a href="#work" onclick="w3_close()" class="w3-bar-item w3-button">Vol
		60</a> <a href="#pricing" onclick="w3_close()"
		class="w3-bar-item w3-button">Nhạc Việt</a> <a href="#contact"
		onclick="w3_close()" class="w3-bar-item w3-button">Nhạc Tiếng Anh</a>
	</nav>
	...
	<!-- About Section -->
	<div class="w3-container" style="padding: 70px 0px" id="about">
		...
		<div class="w3-row-padding w3-center" style="margin-top: 64px">
			<div class="w3-quarter">
				...
				<h4 class="maso">Mã số</h4>
				<h3 class="tenbai">Tên bài hát</h3>
			</div>
			<div class="w3-quarter">
				<img src="${pageContext.request.contextPath }/assets/images/k.jpg"
					width="300px" class="img-responsive" />
