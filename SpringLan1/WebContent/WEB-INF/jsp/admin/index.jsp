						...
						<div class="title_left">
							...
							<ul class="breadcrumb">
								<li><i class="ace-icon fa fa-home home-icon"></i> <a
									href="${pageContext.request.contextPath }/main/welcome.html">Home</a>
								</li>
								<li class="active"><a
									href="${pageContext.request.contextPath }/admin.html">Song
										Management</a></li>
											...
											<thead>
												<tr>
													...
													<th class="sortable" style="width: 5%"
														ng-click="sortType = 'songId';sortReverse = !sortReverse">Song
														ID <span
													...
													<th class="sortable" style="width: 10%"
														ng-click="sortType = 'songName';sortReverse = !sortReverse">Song
														Name <span
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">ThÃÂªm thÃÂ´ng tin trÃ¡ÂºÂ»</h4>
				</div>
					...
					<form class="form-horizontal" name="frmStudentAdd"
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<label class=" control-label" for="">MÃÂ£ trÃ¡ÂºÂ»</label>
								<div class="">
							...
							Text input
							<div class="form-group">
								<label class=" control-label" for="">HÃ¡Â»ï¿½ vÃÂ  tÃÂªn trÃ¡ÂºÂ»</label>
								<div class="">
							...
							<div class="form-group">
								<label class=" control-label" for="birthday">NgÃÂ y Sinh</label>
								<div class="">
							...
							Text input
							<div class="form-group">
								<label class=" control-label" for="birthday">Ãï¿½Ã¡Â»â¹a chÃ¡Â»â°</label>
								<div class="">
							...
							<div class="form-group">
								<label class=" control-label" for="birthday">NgÃÂ y vÃÂ o
									trÃÂ°Ã¡Â»ï¿½ng</label>
								<div class="">
							...
							<div class="form-group">
								<label class="control-label">TÃÂ¬nh trÃ¡ÂºÂ¡ng sÃ¡Â»Â©c khÃ¡Â»ï¿½e</label> <input
							...
							<div class="form-group">
								<label class="control-label">HÃ¡Â»ï¿½ tÃÂªn phÃ¡Â»Â¥ huynh</label> <input
							...
							<div class="form-group">
								<label class="control-label">SÃ¡Â»â ÃâiÃ¡Â»â¡n thoÃ¡ÂºÂ¡i</label> <input
							...
							<div class="form-group">
								<label class="control-label" for="selectbasic">LÃ¡Â»âºp</label>
								<div class="">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">SÃ¡Â»Â­a thÃÂ´ng tin trÃ¡ÂºÂ»</h4>
				</div>
				<div class="modal-body row">
					<form class="form-horizontal" name="editForm">
						<div class="col-md-6">
							...
							Text input
							<div class="form-group">
								<label class="control-label" for="lastName"> HÃ¡Â»ï¿½ vÃÂ  tÃÂªn
									trÃ¡ÂºÂ»</label>
								<div class="">
							...
							Text input
							<div class="form-group">
								<label class=" control-label">NgÃÂ y vÃÂ o trÃÂ°Ã¡Â»ï¿½ng</label>
								<div class="">
						...
						<div class="col-md-6">
							...
							Text input
							<div class="form-group">
								<label class=" control-label" for="birthday">TÃÂ¬nh trÃ¡ÂºÂ¡ng
									sÃ¡Â»Â©c khÃ¡Â»ï¿½e</label>
								<div class="">
							...
							<div class="form-group">
							<label class="control-label">TrÃ¡ÂºÂ¡ng thÃÂ¡i</label>
							<div class="" style="padding: 6px">
								<input type="radio" ng-model="active" ng-value="true" />
								CÃÂ²n hÃ¡Â»ï¿½c <input type="radio" ng-model="active" ng-value="false" />
								Ãï¿½ÃÂ£ nghÃ¡Â»â°
							</div>
						</div>
						</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">ThÃÂ´ng tin chi tiÃ¡ÂºÂ¿t</h4>
				</div>
				<div class="modal-body row">
					<form class="form-horizontal" name="frmStudentView">
						<div class="col-md-6">
							...
							Text input
							<div class="form-group">
								<label class="control-label" for="lastName">MÃÂ£ TrÃ¡ÂºÂ»</label>
								<div class="">
							...
							Text input
							<div class="form-group">
								<label class="control-label" for="firstName">HÃ¡Â»ï¿½ vÃÂ  TÃÂªn
									trÃ¡ÂºÂ»</label>
								<div class="">
							...
							Text input
							<div class="form-group">
								<label class="control-label" for="address">Ãï¿½Ã¡Â»â¹a chÃ¡Â»â°</label>
								<div class="">
							...
							Text input
							<div class="form-group">
								<label class="control-label" for="address">NgÃÂ y vÃÂ o
									trÃÂ°Ã¡Â»ï¿½ng</label>
								<div class="">
							...
							Text input
							<div class="form-group">
								<label class="control-label" for="address">TÃÂ¬nh trÃ¡ÂºÂ¡ng
									sÃ¡Â»Â©c khÃ¡Â»ï¿½e</label>
								<div class="">
						...
						<div class="col-md-6">
							...
							Text input
							<div class="form-group">
								<label class=" control-label" for="gender">GiÃ¡Â»âºi TÃÂ­nh</label>
								<div class="col-md-12">
									<p>{{chitiet.gender ? 'NÃ¡Â»Â¯' : 'Nam'}}</p>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label">HÃ¡Â»ï¿½ tÃÂªn phÃ¡Â»Â¥ huynh</label> <input
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">XÃÂ¡c nhÃ¡ÂºÂ­n</h4>
				</div>
				...
				<div class="modal-body">
					...
					<p>BÃ¡ÂºÂ¡n cÃÂ³ chÃ¡ÂºÂ¯c chÃ¡ÂºÂ¯n muÃ¡Â»ân xÃÂ³a khÃÂ´ng?</p>
				</div>

				<div class="modal-footer">
					<a class="btn btn-danger btn-ok" ng-click="deleteStudent()">CÃÂ³</a>
					<button type="button" class="btn btn-default" data-dismiss="modal">KhÃÂ´ng</button>
