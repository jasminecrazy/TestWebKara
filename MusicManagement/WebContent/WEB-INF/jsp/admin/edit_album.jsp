						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<s:form
										action="${pageContext.request.contextPath }/admin/edit_album.html"
										method="POST" commandName="album">
										<fieldset>

											<!-- Form Name -->
											<legend class="text-center"
												style="color: black; font-weight: bold">Edit album
												information</legend>

											<!-- Text input-->
											<div class="form-group">
												<label class="col-md-4 control-label" for="username">Album
													ID</label>
												<div class="col-md-8">
													<s:hidden path="id" />
													<s:input path="albumId" class="form-control input-md" readonly="true"/>
