						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									...
									<s:form
										action="${pageContext.request.contextPath }/admin/edit_author.html"
										method="POST" commandName="author">
										<fieldset>

											<!-- Form Name -->
											<legend class="text-center"
												style="color: black; font-weight: bold">Edit author
												information</legend>

											<!-- Text input-->
											<div class="form-group">
												<label class="col-md-4 control-label" for="username">Author
													ID</label>
												<div class="col-md-8">
													<s:hidden path="id" />
													<s:input path="authorId" class="form-control input-md"
														readonly="true" />
