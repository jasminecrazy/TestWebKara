							...
							<div class="form-group">
								...
								<div class="">
									<input id="fullName" name="fullName"
										...
										ng-model="add_fullName" ng-required="false" />
								</div>
							</div>
							<!-- Text input-->
							<div class="form-group">
								<label class=" control-label" for="birthday">Password</label>
								<div class="">
									<input id="password" name="password" rows="5"
										class="form-control input-md" type="password"
										ng-model="add_address"/>

								</div>
							</div>
							<div class="form-group">
								<label class=" control-label" for="birthday">Status</label>
								<div class="">
									<input id="status" name="status" placeholder=""
